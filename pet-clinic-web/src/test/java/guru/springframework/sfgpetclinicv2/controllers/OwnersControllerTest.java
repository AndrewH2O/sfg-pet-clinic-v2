...
class OwnersControllerTest extends AbstractMapService {
    ...
    void setUp() {
        ...
        // init a mock env for controller
    ...
    void listOwners() throws Exception {
        ...
        mockMvc.perform(get("/owners"))
                ...
                .andExpect(model().attribute("owners", hasSize(2))); // we added 2 items in setup
    }

    @Test
    void listOwnersWithIndexPath() throws Exception {
        when(ownerService.findAll()).thenReturn(owners);
